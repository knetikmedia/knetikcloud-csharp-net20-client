# com.knetikcloud..Gamification_MetricsApi
...
namespace Example
{
    public class AddMetricExample
    {
        public void main()
        {
            ...
            var apiInstance = new Gamification_MetricsApi();
            ...
            {
                Debug.Print("Exception when calling Gamification_MetricsApi.AddMetric: " + e.Message );
            }
        }
    }
}

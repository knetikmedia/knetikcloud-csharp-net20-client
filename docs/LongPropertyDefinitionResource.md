# com.knetikcloud.Model.ModelLongPropertyDefinitionResource
## Properties
...
**Max** | **long?** | If provided, the maximum value | [optional] [default to null]
**Min** | **long?** | If provided, the minimum value | [optional] [default to null]

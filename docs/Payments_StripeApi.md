# com.knetikcloud..Payments_StripeApi
...
namespace Example
{
    public class CreateStripePaymentMethodExample
    {
        public void main()
        {
            ...
            var apiInstance = new Payments_StripeApi();
            ...
            {
                Debug.Print("Exception when calling Payments_StripeApi.CreateStripePaymentMethod: " + e.Message );
            }
        }
    }
}
...
namespace Example
{
    public class PayStripeInvoiceExample
    {
        public void main()
        {
            ...
            {
                Debug.Print("Exception when calling Payments_StripeApi.PayStripeInvoice: " + e.Message );
            }
        }
    }
}

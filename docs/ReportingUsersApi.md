# com.knetikcloud..ReportingUsersApi
...
> ModelPageResourceAggregateCountResource GetUserRegistrations (string granularity, long? startDate, long? endDate)
...
namespace Example
{
    public class GetUserRegistrationsExample
    {
        public void main()
        {
            ...
            {
                // Get user registration info
                ModelPageResourceAggregateCountResource result = apiInstance.GetUserRegistrations(granularity, startDate, endDate);

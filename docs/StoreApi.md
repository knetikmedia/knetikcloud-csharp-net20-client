...
namespace Example
{
    public class GetStoreItemsExample
    {
        public void main()
        {
            ...
            {
                // List and search store items
                ModelPageResourceStoreItem result = apiInstance.GetStoreItems(filterNameSearch, filterUniqueKey, filterPublished, filterDisplayable, filterStart, filterEnd, filterStartDate, filterStopDate, filterSku, filterPrice, filterTag, filterItemsByType, filterBundledSkus, size, page, order);
                Debug.WriteLine(result);
            }
            catch (Exception e)
            {

# com.knetikcloud..UsersFriendshipsApi
...
<a name="getfriends"></a>
# **GetFriends**
> ModelPageResourceSimpleUserResource GetFriends (string userId, int? size, int? page, string order)
...
namespace Example
{
    public class GetFriendsExample
    {
        public void main()
        {
            ...
            {
                // Get friends list
                ModelPageResourceSimpleUserResource result = apiInstance.GetFriends(userId, size, page, order);
...
<a name="getinvites"></a>
# **GetInvites**
> ModelPageResourceSimpleUserResource GetInvites (string userId, int? size, int? page, string order)
...
namespace Example
{
    public class GetInvitesExample
    {
        public void main()
        {
            ...
            {
                // Get pending invites
                ModelPageResourceSimpleUserResource result = apiInstance.GetInvites(userId, size, page, order);
                Debug.WriteLine(result);
            }
            catch (Exception e)
            {

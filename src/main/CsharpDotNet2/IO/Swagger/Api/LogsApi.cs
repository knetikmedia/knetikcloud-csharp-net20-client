...
namespace IO.Swagger.Api
{
    ...
    public interface ILogsApi
    {
        ...
        PageResourceBreEventLog GetBREEventLogs (string filterStartDate, string filterEventName, int? size, int? page, string order);
        /// <summary>
        ...
        PageResourceUserActionLog GetUserLogs (int? filterUser, string filterActionName, int? size, int? page);
    }
    ...
    public class LogsApi : ILogsApi
    {
        ...
        /// <param name="order">A comma separated list of sorting requirements in priority order, each entry matching PROPERTY_NAME:[ASC|DESC]</param> 
        /// <returns>PageResourceBreEventLog</returns>            
        public PageResourceBreEventLog GetBREEventLogs (string filterStartDate, string filterEventName, int? size, int? page, string order)
        {
 ...
 if (order != null) queryParams.Add("order", ApiClient.ParameterToString(order)); // query parameter
        ...
        /// <param name="page">The number of the page returned, starting with 1</param> 
        /// <returns>PageResourceUserActionLog</returns>            
        public PageResourceUserActionLog GetUserLogs (int? filterUser, string filterActionName, int? size, int? page)
        {

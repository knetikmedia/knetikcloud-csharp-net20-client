...
namespace IO.Swagger.Api
{
    ...
    public interface IReportingChallengesApi
    {
        ...
        PageResourceChallengeEventParticipantResource GetChallengeEventLeaderboard (long? filterEvent);
        /// <summary>
        ...
        /// <param name="filterEvent">A sepecific challenge event id</param>
        /// <returns>PageResourceChallengeEventParticipantResource</returns>
        PageResourceChallengeEventParticipantResource GetChallengeEventParticipants (long? filterEvent);
    }
    ...
    public class ReportingChallengesApi : IReportingChallengesApi
    {
        ...
        /// <param name="filterEvent">A sepecific challenge event id</param> 
        /// <returns>PageResourceChallengeEventParticipantResource</returns>            
        public PageResourceChallengeEventParticipantResource GetChallengeEventLeaderboard (long? filterEvent)
        {
        ...
        /// <param name="filterEvent">A sepecific challenge event id</param> 
        /// <returns>PageResourceChallengeEventParticipantResource</returns>            
        public PageResourceChallengeEventParticipantResource GetChallengeEventParticipants (long? filterEvent)
        {

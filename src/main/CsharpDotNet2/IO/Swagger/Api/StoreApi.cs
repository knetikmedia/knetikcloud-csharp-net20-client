...
namespace IO.Swagger.Api
{
 ...
 if (page != null) queryParams.Add("page", ApiClient.ParameterToString(page)); // query parameter
 if (useCatalog != null) queryParams.Add("use_catalog", ApiClient.ParameterToString(useCatalog)); // query parameter
 if (ignoreLocation != null) queryParams.Add("ignore_location", ApiClient.ParameterToString(ignoreLocation)); // query parameter
 if (inStockOnly != null) queryParams.Add("in_stock_only", ApiClient.ParameterToString(inStockOnly)); // query parameter
            ...
            if (((int)response.StatusCode) >= 400)
                throw new ApiException ((int)response.StatusCode, "Error calling GetStore: " + response.Content, response.Content);
            else if (((int)response.StatusCode) == 0)

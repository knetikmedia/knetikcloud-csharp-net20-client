...
namespace com.knetikcloud.Api
{
    ...
    public interface IActivitiesApi
    {
        ...
        /// <returns>ModelActivityResource</returns>
        ...
        /// <returns>ModelActivityOccurrenceResource</returns>
    ...
    public class ActivitiesApi : IActivitiesApi
    {
        ...
        /// <param name="activityResource">The activity resource object</param> 
        /// <returns>ModelActivityResource</returns>            
        public ModelActivityResource CreateActivity (ModelActivityResource activityResource)
        {
            ...
            return (ModelActivityResource) ApiClient.Deserialize(response.Content, typeof(ModelActivityResource), response.Headers);
        }
        ...
        /// <param name="activityOccurrenceResource">The activity occurrence object</param> 
        /// <returns>ModelActivityOccurrenceResource</returns>            
        public ModelActivityOccurrenceResource CreateActivityOccurrence (bool? test, ModelActivityOccurrenceResource activityOccurrenceResource)
        {
            ...
            return (ModelActivityOccurrenceResource) ApiClient.Deserialize(response.Content, typeof(ModelActivityOccurrenceResource), response.Headers);
        }
        ...
        /// <param name="order">A comma separated list of sorting requirements in priority order, each entry matching PROPERTY_NAME:[ASC|DESC]</param> 
        /// <returns>ModelPageResourceBareActivityResource</returns>            
        public ModelPageResourceBareActivityResource GetActivities (bool? filterTemplate, string filterName, string filterId, int? size, int? page, string order)
        {
 ...
 if (order != null) queryParams.Add("order", ApiClient.ParameterToString(order)); // query parameter
        ...
        /// <param name="id">The id of the activity</param> 
        /// <returns>ModelActivityResource</returns>            
        public ModelActivityResource GetActivity (long? id)
        {
        ...
        /// <param name="activityResource">The activity resource object</param> 
        /// <returns>ModelActivityResource</returns>            
        public ModelActivityResource UpdateActivity (long? id, ModelActivityResource activityResource)
        {

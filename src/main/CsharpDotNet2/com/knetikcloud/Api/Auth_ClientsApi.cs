...
namespace com.knetikcloud.Api
{
    ...
    /// </summary>
    public interface IAuth_ClientsApi
    {
        /// <summary>
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public class Auth_ClientsApi : IAuth_ClientsApi
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Auth_ClientsApi"/> class.
        /// </summary>
        /// <param name="apiClient"> an instance of ApiClient (optional)</param>
        /// <returns></returns>
        public Auth_ClientsApi(ApiClient apiClient = null)
        {
        ...
        /// </summary>
        /// <returns></returns>
        public Auth_ClientsApi(String basePath)
        {

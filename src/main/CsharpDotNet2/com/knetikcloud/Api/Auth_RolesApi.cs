...
namespace com.knetikcloud.Api
{
    ...
    /// </summary>
    public interface IAuth_RolesApi
    {
        /// <summary>
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public class Auth_RolesApi : IAuth_RolesApi
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Auth_RolesApi"/> class.
        /// </summary>
        /// <param name="apiClient"> an instance of ApiClient (optional)</param>
        /// <returns></returns>
        public Auth_RolesApi(ApiClient apiClient = null)
        {
        ...
        /// </summary>
        /// <returns></returns>
        public Auth_RolesApi(String basePath)
        {

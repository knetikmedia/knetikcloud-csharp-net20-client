...
namespace com.knetikcloud.Api
{
    ...
    /// </summary>
    public interface ICampaigns_RewardsApi
    {
        /// <summary>
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public class Campaigns_RewardsApi : ICampaigns_RewardsApi
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Campaigns_RewardsApi"/> class.
        /// </summary>
        /// <param name="apiClient"> an instance of ApiClient (optional)</param>
        /// <returns></returns>
        public Campaigns_RewardsApi(ApiClient apiClient = null)
        {
        ...
        /// </summary>
        /// <returns></returns>
        public Campaigns_RewardsApi(String basePath)
        {

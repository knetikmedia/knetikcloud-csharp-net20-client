...
namespace com.knetikcloud.Api
{
    ...
    public interface IContentArticlesApi
    {
        ...
        PageResourceArticleResource GetArticles (string filterCategory, string filterTagset, string filterTitle, int? size, int? page, string order);
        /// <summary>
 ...
 if (order != null) queryParams.Add("order", ApiClient.ParameterToString(order)); // query parameter
        ...
        /// <param name="order">A comma separated list of sorting requirements in priority order, each entry matching PROPERTY_NAME:[ASC|DESC]</param> 
        /// <returns>PageResourceArticleResource</returns>            
        public PageResourceArticleResource GetArticles (string filterCategory, string filterTagset, string filterTitle, int? size, int? page, string order)
        {

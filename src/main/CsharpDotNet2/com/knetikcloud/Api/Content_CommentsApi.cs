...
namespace com.knetikcloud.Api
{
    ...
    /// </summary>
    public interface IContent_CommentsApi
    {
        /// <summary>
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public class Content_CommentsApi : IContent_CommentsApi
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Content_CommentsApi"/> class.
        /// </summary>
        /// <param name="apiClient"> an instance of ApiClient (optional)</param>
        /// <returns></returns>
        public Content_CommentsApi(ApiClient apiClient = null)
        {
        ...
        /// </summary>
        /// <returns></returns>
        public Content_CommentsApi(String basePath)
        {

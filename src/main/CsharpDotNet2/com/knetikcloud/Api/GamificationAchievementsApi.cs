...
namespace com.knetikcloud.Api
{
    ...
    public interface IGamificationAchievementsApi
    {
        ...
        /// <returns>ModelUserAchievementGroupResource</returns>
        ModelUserAchievementGroupResource UpdateAchievementProgress (int? userId, string achievementName, ModelAchievementProgressUpdateRequest request);
        /// <summary>
 ...
 if (order != null) queryParams.Add("order", ApiClient.ParameterToString(order)); // query parameter
        ...
        /// <param name="order">A comma separated list of sorting requirements in priority order, each entry matching PROPERTY_NAME:[ASC|DESC]</param> 
        /// <returns>ModelPageResourceAchievementDefinitionResource</returns>            
        public ModelPageResourceAchievementDefinitionResource GetAchievements (string filterTagset, string filterName, bool? filterHidden, bool? filterDerived, int? size, int? page, string order)
        {
...
path = path.Replace("{" + "achievement_name" + "}", ApiClient.ParameterToString(achievementName));
 ...
 if (page != null) queryParams.Add("page", ApiClient.ParameterToString(page)); // query parameter
        ...
        /// <param name="request">The progress update details</param> 
        /// <returns>ModelUserAchievementGroupResource</returns>            
        public ModelUserAchievementGroupResource UpdateAchievementProgress (int? userId, string achievementName, ModelAchievementProgressUpdateRequest request)
        {

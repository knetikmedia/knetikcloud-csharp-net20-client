...
namespace com.knetikcloud.Api
{
    ...
    /// </summary>
    public interface IGamification_AchievementsApi
    {
        /// <summary>
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public class Gamification_AchievementsApi : IGamification_AchievementsApi
    {
        /// <summary>
        ...
        /// <returns></returns>
        public Gamification_AchievementsApi(ApiClient apiClient = null)
        {

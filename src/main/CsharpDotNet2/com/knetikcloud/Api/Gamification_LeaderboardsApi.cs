...
namespace com.knetikcloud.Api
{
    ...
    /// </summary>
    public interface IGamification_LeaderboardsApi
    {
        /// <summary>
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public class Gamification_LeaderboardsApi : IGamification_LeaderboardsApi
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Gamification_LeaderboardsApi"/> class.
        /// </summary>
        /// <param name="apiClient"> an instance of ApiClient (optional)</param>
        /// <returns></returns>
        public Gamification_LeaderboardsApi(ApiClient apiClient = null)
        {
        ...
        /// </summary>
        /// <returns></returns>
        public Gamification_LeaderboardsApi(String basePath)
        {

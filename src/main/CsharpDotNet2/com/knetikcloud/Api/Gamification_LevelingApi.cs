...
namespace com.knetikcloud.Api
{
    ...
    /// </summary>
    public interface IGamification_LevelingApi
    {
        /// <summary>
        ...
        /// <summary>
        /// Retrieve a level &lt;b&gt;Permissions Needed:&lt;/b&gt; LEVELING_USER
        /// </summary>
        /// <param name="name">The level schema name</param>
        /// <returns>LevelingResource</returns>
        ...
        /// <summary>
        /// List and search levels Get a list of levels schemas with optional filtering. &lt;br&gt;&lt;br&gt;&lt;b&gt;Permissions Needed:&lt;/b&gt; LEVELING_USER
        /// </summary>
        ...
        /// <summary>
        /// Get a user&#39;s progress for a given level schema &lt;b&gt;Permissions Needed:&lt;/b&gt; LEVELING_USER or self
        /// </summary>
        ...
        /// <summary>
        /// Get a user&#39;s progress for all level schemas Filtering and sorting is based on the LevelingResource object, not the UserLevelingResource that is returned here. &lt;br&gt;&lt;br&gt;&lt;b&gt;Permissions Needed:&lt;/b&gt; LEVELING_USER or self
        /// </summary>
        /// <param name="userId">The id of the user or &#39;me&#39;</param>
        /// <param name="filterName">Filter for level schemas whose name contains a given string</param>
        /// <param name="size">The number of objects returned per page</param>
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public class Gamification_LevelingApi : IGamification_LevelingApi
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Gamification_LevelingApi"/> class.
        /// </summary>
        /// <param name="apiClient"> an instance of ApiClient (optional)</param>
        /// <returns></returns>
        public Gamification_LevelingApi(ApiClient apiClient = null)
        {
        ...
        /// </summary>
        /// <returns></returns>
        public Gamification_LevelingApi(String basePath)
        {
 ...
 if (order != null) queryParams.Add("order", ApiClient.ParameterToString(order)); // query parameter
        ...
        /// <param name="name">The level schema name</param> 
        /// <returns>UserLevelingResource</returns>            
        public UserLevelingResource GetUserLevel (string userId, string name)
        {
...
path = path.Replace("{" + "name" + "}", ApiClient.ParameterToString(name));
        ...
        /// <param name="order">A comma separated list of sorting requirements in priority order, each entry matching PROPERTY_NAME:[ASC|DESC]</param> 
        /// <returns>PageResourceUserLevelingResource</returns>            
        public PageResourceUserLevelingResource GetUserLevels (string userId, string filterName, int? size, int? page, string order)
        {

...
namespace com.knetikcloud.Api
{
    ...
    /// </summary>
    public interface IMessaging_TopicsApi
    {
        /// <summary>
        /// Enable or disable messages for a user Useful for opt-out options on a single topic. Consider multiple topics for multiple opt-out options. &lt;br&gt;&lt;br&gt;&lt;b&gt;Permissions Needed:&lt;/b&gt; TOPICS_ADMIN or self
        /// </summary>
        ...
        /// <summary>
        /// Get a subscriber to a topic &lt;b&gt;Permissions Needed:&lt;/b&gt; TOPICS_ADMIN or self
        /// </summary>
        /// <param name="id">The id of the topic</param>
        /// <param name="userId">The id of the subscriber or &#39;me&#39;</param>
        ...
        /// <summary>
        /// Get all messaging topics for a given user &lt;b&gt;Permissions Needed:&lt;/b&gt; TOPICS_ADMIN or self
        /// </summary>
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public class Messaging_TopicsApi : IMessaging_TopicsApi
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Messaging_TopicsApi"/> class.
        /// </summary>
        /// <param name="apiClient"> an instance of ApiClient (optional)</param>
        /// <returns></returns>
        public Messaging_TopicsApi(ApiClient apiClient = null)
        {
        ...
        /// </summary>
        /// <returns></returns>
        public Messaging_TopicsApi(String basePath)
        {

...
namespace com.knetikcloud.Api
{
    ...
    public interface IPaymentsApi
    {
        ...
        List<PaymentMethodResource> GetPaymentMethods (int? userId, int? size, int? page, string order);
        /// <summary>
...
path = path.Replace("{" + "id" + "}", ApiClient.ParameterToString(id));
        ...
        /// <param name="order">a comma separated list of sorting requirements in priority order, each entry matching PROPERTY_NAME:[ASC|DESC]</param> 
        /// <returns>List&lt;PaymentMethodResource&gt;</returns>            
        public List<PaymentMethodResource> GetPaymentMethods (int? userId, int? size, int? page, string order)
        {

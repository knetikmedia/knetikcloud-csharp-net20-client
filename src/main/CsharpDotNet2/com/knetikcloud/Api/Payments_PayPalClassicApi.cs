...
namespace com.knetikcloud.Api
{
    ...
    /// </summary>
    public interface IPayments_PayPalClassicApi
    {
        /// <summary>
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public class Payments_PayPalClassicApi : IPayments_PayPalClassicApi
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Payments_PayPalClassicApi"/> class.
        /// </summary>
        /// <param name="apiClient"> an instance of ApiClient (optional)</param>
        /// <returns></returns>
        public Payments_PayPalClassicApi(ApiClient apiClient = null)
        {
        ...
        /// </summary>
        /// <returns></returns>
        public Payments_PayPalClassicApi(String basePath)
        {

...
namespace com.knetikcloud.Api
{
    ...
    /// </summary>
    public interface IPayments_StripeApi
    {
        /// <summary>
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public class Payments_StripeApi : IPayments_StripeApi
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Payments_StripeApi"/> class.
        /// </summary>
        /// <param name="apiClient"> an instance of ApiClient (optional)</param>
        /// <returns></returns>
        public Payments_StripeApi(ApiClient apiClient = null)
        {
        ...
        /// </summary>
        /// <returns></returns>
        public Payments_StripeApi(String basePath)
        {

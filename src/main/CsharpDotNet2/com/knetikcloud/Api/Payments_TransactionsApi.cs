...
namespace com.knetikcloud.Api
{
    ...
    /// </summary>
    public interface IPayments_TransactionsApi
    {
        /// <summary>
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public class Payments_TransactionsApi : IPayments_TransactionsApi
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Payments_TransactionsApi"/> class.
        /// </summary>
        /// <param name="apiClient"> an instance of ApiClient (optional)</param>
        /// <returns></returns>
        public Payments_TransactionsApi(ApiClient apiClient = null)
        {
        ...
        /// </summary>
        /// <returns></returns>
        public Payments_TransactionsApi(String basePath)
        {

...
namespace com.knetikcloud.Api
{
    ...
    /// </summary>
    public interface IPayments_WalletsApi
    {
        /// <summary>
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public class Payments_WalletsApi : IPayments_WalletsApi
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Payments_WalletsApi"/> class.
        /// </summary>
        /// <param name="apiClient"> an instance of ApiClient (optional)</param>
        /// <returns></returns>
        public Payments_WalletsApi(ApiClient apiClient = null)
        {
        ...
        /// </summary>
        /// <returns></returns>
        public Payments_WalletsApi(String basePath)
        {

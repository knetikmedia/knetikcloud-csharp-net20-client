...
namespace com.knetikcloud.Api
{
    ...
    public class ReportingOrdersApi : IReportingOrdersApi
    {
        ...
        /// <param name="endDate">The end of the time range to return, unix timestamp in seconds. Default is end of time</param> 
        /// <returns>ModelPageResourceAggregateInvoiceReportResource</returns>            
        public ModelPageResourceAggregateInvoiceReportResource GetInvoiceReports (string currencyCode, string granularity, string filterPaymentStatus, string filterFulfillmentStatus, long? startDate, long? endDate)
        {

...
namespace com.knetikcloud.Api
{
    ...
    /// </summary>
    public interface IReporting_ChallengesApi
    {
        /// <summary>
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public class Reporting_ChallengesApi : IReporting_ChallengesApi
    {
        /// <summary>
        ...
        /// <returns></returns>
        public Reporting_ChallengesApi(ApiClient apiClient = null)
        {

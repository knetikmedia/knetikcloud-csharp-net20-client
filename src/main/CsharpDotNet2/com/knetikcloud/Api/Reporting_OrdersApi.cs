...
namespace com.knetikcloud.Api
{
    ...
    /// </summary>
    public interface IReporting_OrdersApi
    {
        /// <summary>
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public class Reporting_OrdersApi : IReporting_OrdersApi
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Reporting_OrdersApi"/> class.
        /// </summary>
        /// <param name="apiClient"> an instance of ApiClient (optional)</param>
        /// <returns></returns>
        public Reporting_OrdersApi(ApiClient apiClient = null)
        {
        ...
        /// </summary>
        /// <returns></returns>
        public Reporting_OrdersApi(String basePath)
        {

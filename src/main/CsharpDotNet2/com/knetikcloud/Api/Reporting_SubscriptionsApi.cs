...
namespace com.knetikcloud.Api
{
    ...
    /// </summary>
    public interface IReporting_SubscriptionsApi
    {
        /// <summary>
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public class Reporting_SubscriptionsApi : IReporting_SubscriptionsApi
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Reporting_SubscriptionsApi"/> class.
        /// </summary>
        /// <param name="apiClient"> an instance of ApiClient (optional)</param>
        /// <returns></returns>
        public Reporting_SubscriptionsApi(ApiClient apiClient = null)
        {
        ...
        /// </summary>
        /// <returns></returns>
        public Reporting_SubscriptionsApi(String basePath)
        {

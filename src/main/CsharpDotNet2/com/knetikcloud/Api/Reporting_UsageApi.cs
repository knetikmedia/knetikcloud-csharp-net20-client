...
namespace com.knetikcloud.Api
{
    ...
    /// </summary>
    public interface IReporting_UsageApi
    {
        /// <summary>
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public class Reporting_UsageApi : IReporting_UsageApi
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Reporting_UsageApi"/> class.
        /// </summary>
        /// <param name="apiClient"> an instance of ApiClient (optional)</param>
        /// <returns></returns>
        public Reporting_UsageApi(ApiClient apiClient = null)
        {
        ...
        /// </summary>
        /// <returns></returns>
        public Reporting_UsageApi(String basePath)
        {

...
namespace com.knetikcloud.Api
{
    ...
    /// </summary>
    public interface IReporting_UsersApi
    {
        /// <summary>
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public class Reporting_UsersApi : IReporting_UsersApi
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Reporting_UsersApi"/> class.
        /// </summary>
        /// <param name="apiClient"> an instance of ApiClient (optional)</param>
        /// <returns></returns>
        public Reporting_UsersApi(ApiClient apiClient = null)
        {
        ...
        /// </summary>
        /// <returns></returns>
        public Reporting_UsersApi(String basePath)
        {

...
namespace com.knetikcloud.Api
{
    ...
    /// </summary>
    public interface IRule_Engine_ActionsApi
    {
        /// <summary>
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public class Rule_Engine_ActionsApi : IRule_Engine_ActionsApi
    {
        /// <summary>
        ...
        /// <returns></returns>
        public Rule_Engine_ActionsApi(ApiClient apiClient = null)
        {

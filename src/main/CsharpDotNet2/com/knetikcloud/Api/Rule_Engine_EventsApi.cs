...
namespace com.knetikcloud.Api
{
    ...
    /// </summary>
    public interface IRule_Engine_EventsApi
    {
        /// <summary>
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public class Rule_Engine_EventsApi : IRule_Engine_EventsApi
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Rule_Engine_EventsApi"/> class.
        /// </summary>
        /// <param name="apiClient"> an instance of ApiClient (optional)</param>
        /// <returns></returns>
        public Rule_Engine_EventsApi(ApiClient apiClient = null)
        {
        ...
        /// </summary>
        /// <returns></returns>
        public Rule_Engine_EventsApi(String basePath)
        {

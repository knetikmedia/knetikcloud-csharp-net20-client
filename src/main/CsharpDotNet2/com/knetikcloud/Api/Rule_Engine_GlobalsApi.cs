...
namespace com.knetikcloud.Api
{
    ...
    /// </summary>
    public interface IRule_Engine_GlobalsApi
    {
        /// <summary>
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public class Rule_Engine_GlobalsApi : IRule_Engine_GlobalsApi
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Rule_Engine_GlobalsApi"/> class.
        /// </summary>
        /// <param name="apiClient"> an instance of ApiClient (optional)</param>
        /// <returns></returns>
        public Rule_Engine_GlobalsApi(ApiClient apiClient = null)
        {
        ...
        /// </summary>
        /// <returns></returns>
        public Rule_Engine_GlobalsApi(String basePath)
        {

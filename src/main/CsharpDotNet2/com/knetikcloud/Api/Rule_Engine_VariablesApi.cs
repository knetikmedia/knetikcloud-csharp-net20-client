...
namespace com.knetikcloud.Api
{
    ...
    /// </summary>
    public interface IRule_Engine_VariablesApi
    {
        /// <summary>
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public class Rule_Engine_VariablesApi : IRule_Engine_VariablesApi
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Rule_Engine_VariablesApi"/> class.
        /// </summary>
        /// <param name="apiClient"> an instance of ApiClient (optional)</param>
        /// <returns></returns>
        public Rule_Engine_VariablesApi(ApiClient apiClient = null)
        {
        ...
        /// </summary>
        /// <returns></returns>
        public Rule_Engine_VariablesApi(String basePath)
        {

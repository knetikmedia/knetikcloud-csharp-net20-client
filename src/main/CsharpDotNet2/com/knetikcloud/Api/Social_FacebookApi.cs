...
namespace com.knetikcloud.Api
{
    ...
    /// </summary>
    public interface ISocial_FacebookApi
    {
        /// <summary>
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public class Social_FacebookApi : ISocial_FacebookApi
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Social_FacebookApi"/> class.
        /// </summary>
        /// <param name="apiClient"> an instance of ApiClient (optional)</param>
        /// <returns></returns>
        public Social_FacebookApi(ApiClient apiClient = null)
        {
        ...
        /// </summary>
        /// <returns></returns>
        public Social_FacebookApi(String basePath)
        {

...
namespace com.knetikcloud.Api
{
    ...
    /// </summary>
    public interface ISocial_GoogleApi
    {
        /// <summary>
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public class Social_GoogleApi : ISocial_GoogleApi
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Social_GoogleApi"/> class.
        /// </summary>
        /// <param name="apiClient"> an instance of ApiClient (optional)</param>
        /// <returns></returns>
        public Social_GoogleApi(ApiClient apiClient = null)
        {
        ...
        /// </summary>
        /// <returns></returns>
        public Social_GoogleApi(String basePath)
        {

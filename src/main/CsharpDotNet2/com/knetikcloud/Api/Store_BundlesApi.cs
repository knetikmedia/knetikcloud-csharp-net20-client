...
namespace com.knetikcloud.Api
{
    ...
    /// </summary>
    public interface IStore_BundlesApi
    {
        /// <summary>
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public class Store_BundlesApi : IStore_BundlesApi
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Store_BundlesApi"/> class.
        /// </summary>
        /// <param name="apiClient"> an instance of ApiClient (optional)</param>
        /// <returns></returns>
        public Store_BundlesApi(ApiClient apiClient = null)
        {
        ...
        /// </summary>
        /// <returns></returns>
        public Store_BundlesApi(String basePath)
        {

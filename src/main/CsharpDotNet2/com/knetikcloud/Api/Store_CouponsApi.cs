...
namespace com.knetikcloud.Api
{
    ...
    /// </summary>
    public interface IStore_CouponsApi
    {
        /// <summary>
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public class Store_CouponsApi : IStore_CouponsApi
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Store_CouponsApi"/> class.
        /// </summary>
        /// <param name="apiClient"> an instance of ApiClient (optional)</param>
        /// <returns></returns>
        public Store_CouponsApi(ApiClient apiClient = null)
        {
        ...
        /// </summary>
        /// <returns></returns>
        public Store_CouponsApi(String basePath)
        {
        ...
        public CouponItem GetCouponItemBySku (string sku)
        {
            ...
            if (sku == null) throw new ApiException(400, "Missing required parameter 'sku' when calling GetCouponItemBySku");
            ...
            if (((int)response.StatusCode) >= 400)
                throw new ApiException ((int)response.StatusCode, "Error calling GetCouponItemBySku: " + response.Content, response.Content);
            else if (((int)response.StatusCode) == 0)
                throw new ApiException ((int)response.StatusCode, "Error calling GetCouponItemBySku: " + response.ErrorMessage, response.ErrorMessage);

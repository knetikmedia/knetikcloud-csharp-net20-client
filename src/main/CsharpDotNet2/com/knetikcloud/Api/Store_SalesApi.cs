...
namespace com.knetikcloud.Api
{
    ...
    /// </summary>
    public interface IStore_SalesApi
    {
        /// <summary>
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public class Store_SalesApi : IStore_SalesApi
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Store_SalesApi"/> class.
        /// </summary>
        /// <param name="apiClient"> an instance of ApiClient (optional)</param>
        /// <returns></returns>
        public Store_SalesApi(ApiClient apiClient = null)
        {
        ...
        /// </summary>
        /// <returns></returns>
        public Store_SalesApi(String basePath)
        {

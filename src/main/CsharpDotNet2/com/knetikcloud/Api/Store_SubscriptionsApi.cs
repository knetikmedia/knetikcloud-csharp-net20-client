...
namespace com.knetikcloud.Api
{
    ...
    /// </summary>
    public interface IStore_SubscriptionsApi
    {
        /// <summary>
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public class Store_SubscriptionsApi : IStore_SubscriptionsApi
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Store_SubscriptionsApi"/> class.
        /// </summary>
        /// <param name="apiClient"> an instance of ApiClient (optional)</param>
        /// <returns></returns>
        public Store_SubscriptionsApi(ApiClient apiClient = null)
        {
        ...
        /// </summary>
        /// <returns></returns>
        public Store_SubscriptionsApi(String basePath)
        {

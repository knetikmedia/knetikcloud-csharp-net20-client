...
namespace com.knetikcloud.Api
{
    ...
    /// </summary>
    public interface IStore_VendorsApi
    {
        /// <summary>
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public class Store_VendorsApi : IStore_VendorsApi
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Store_VendorsApi"/> class.
        /// </summary>
        /// <param name="apiClient"> an instance of ApiClient (optional)</param>
        /// <returns></returns>
        public Store_VendorsApi(ApiClient apiClient = null)
        {
        ...
        /// </summary>
        /// <returns></returns>
        public Store_VendorsApi(String basePath)
        {

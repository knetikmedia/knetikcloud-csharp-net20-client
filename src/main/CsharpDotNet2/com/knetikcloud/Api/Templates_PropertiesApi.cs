...
namespace com.knetikcloud.Api
{
    ...
    /// </summary>
    public interface ITemplates_PropertiesApi
    {
        /// <summary>
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public class Templates_PropertiesApi : ITemplates_PropertiesApi
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Templates_PropertiesApi"/> class.
        /// </summary>
        /// <param name="apiClient"> an instance of ApiClient (optional)</param>
        /// <returns></returns>
        public Templates_PropertiesApi(ApiClient apiClient = null)
        {
        ...
        /// </summary>
        /// <returns></returns>
        public Templates_PropertiesApi(String basePath)
        {

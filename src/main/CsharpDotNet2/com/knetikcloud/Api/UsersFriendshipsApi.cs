...
namespace com.knetikcloud.Api
{
    ...
    public interface IUsersFriendshipsApi
    {
        ...
        PageResourceSimpleUserResource GetFriends (string userId, int? size, int? page, string order);
        /// <summary>
        ...
        /// <param name="order">A comma separated list of sorting requirements in priority order, each entry matching PROPERTY_NAME:[ASC|DESC]</param>
        /// <returns>PageResourceSimpleUserResource</returns>
        PageResourceSimpleUserResource GetInvites (string userId, int? size, int? page, string order);
        /// <summary>
...
path = path.Replace("{" + "id" + "}", ApiClient.ParameterToString(id));
        ...
        /// <param name="order">A comma separated list of sorting requirements in priority order, each entry matching PROPERTY_NAME:[ASC|DESC]</param> 
        /// <returns>PageResourceSimpleUserResource</returns>            
        public PageResourceSimpleUserResource GetFriends (string userId, int? size, int? page, string order)
        {
 ...
 if (order != null) queryParams.Add("order", ApiClient.ParameterToString(order)); // query parameter
        ...
        /// <param name="order">A comma separated list of sorting requirements in priority order, each entry matching PROPERTY_NAME:[ASC|DESC]</param> 
        /// <returns>PageResourceSimpleUserResource</returns>            
        public PageResourceSimpleUserResource GetInvites (string userId, int? size, int? page, string order)
        {

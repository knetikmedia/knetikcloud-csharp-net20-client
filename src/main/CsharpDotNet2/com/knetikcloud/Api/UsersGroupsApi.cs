...
namespace com.knetikcloud.Api
{
    ...
    public interface IUsersGroupsApi
    {
        ...
        ModelPageResourceGroupResource UpdateGroups (string filterName, string filterUniqueName, string filterParent, int? size, int? page, string order);
    }
    ...
    public class UsersGroupsApi : IUsersGroupsApi
    {
        ...
        /// <param name="username">The username of a user to add to the group</param> 
        /// <returns>ModelGroupMemberResource</returns>            
        public ModelGroupMemberResource AddMemberToGroup (string uniqueName, ModelGroupMemberResource username)
        {
...
path = path.Replace("{" + "user_id" + "}", ApiClient.ParameterToString(userId));
        ...
        /// <param name="order">A comma separated list of sorting requirements in priority order, each entry matching PROPERTY_NAME:[ASC|DESC]</param> 
        /// <returns>ModelPageResourceGroupResource</returns>            
        public ModelPageResourceGroupResource UpdateGroups (string filterName, string filterUniqueName, string filterParent, int? size, int? page, string order)
        {

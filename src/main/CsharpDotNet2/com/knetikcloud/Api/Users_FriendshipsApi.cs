...
namespace com.knetikcloud.Api
{
    ...
    /// </summary>
    public interface IUsers_FriendshipsApi
    {
        /// <summary>
        ...
        /// <summary>
        /// Returns the invite token This is a unique invite token that allows direct connection to the request user.  Exposing that token presents privacy issues if the token is leaked. Use friend request flow instead if confirmation is required. &lt;br&gt;&lt;br&gt;&lt;b&gt;Permissions Needed:&lt;/b&gt; FRIENDSHIPS_ADMIN or (FRIENDSHIPS_USER and owner)
        /// </summary>
        /// <param name="userId">The id of the user or &#39;me&#39; if logged in</param>
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public class Users_FriendshipsApi : IUsers_FriendshipsApi
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Users_FriendshipsApi"/> class.
        /// </summary>
        /// <param name="apiClient"> an instance of ApiClient (optional)</param>
        /// <returns></returns>
        public Users_FriendshipsApi(ApiClient apiClient = null)
        {
        ...
        /// </summary>
        /// <returns></returns>
        public Users_FriendshipsApi(String basePath)
        {
...
path = path.Replace("{" + "id" + "}", ApiClient.ParameterToString(id));
        ...
        /// <param name="page">The number of the page returned, starting with 1</param> 
        /// <returns>PageResourceSimpleUserResource</returns>            
        public PageResourceSimpleUserResource GetFriends (string userId, string filterUsername, int? filterUserId, int? size, int? page)
        {

...
namespace com.knetikcloud.Api
{
    ...
    /// </summary>
    public interface IUsers_InventoryApi
    {
        /// <summary>
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public class Users_InventoryApi : IUsers_InventoryApi
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Users_InventoryApi"/> class.
        /// </summary>
        /// <param name="apiClient"> an instance of ApiClient (optional)</param>
        /// <returns></returns>
        public Users_InventoryApi(ApiClient apiClient = null)
        {
        ...
        /// </summary>
        /// <returns></returns>
        public Users_InventoryApi(String basePath)
        {
...
path = path.Replace("{" + "id" + "}", ApiClient.ParameterToString(id));
        ...
        /// <param name="inventoryStatus">The inventory status object</param> 
        /// <returns></returns>            
        public void UpdateUserInventoryStatus (int? userId, int? id, InventoryStatusWrapper inventoryStatus)
        {

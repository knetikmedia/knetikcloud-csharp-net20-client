...
namespace com.knetikcloud.Api
{
    ...
    /// </summary>
    public interface IUsers_SubscriptionsApi
    {
        /// <summary>
        ...
        /// <param name="userId">The id of the user</param>
        /// <param name="inventoryId">The id of the user&#39;s inventory</param>
        /// <param name="status">The new status for the subscription</param>
        /// <returns></returns>
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public class Users_SubscriptionsApi : IUsers_SubscriptionsApi
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Users_SubscriptionsApi"/> class.
        /// </summary>
        /// <param name="apiClient"> an instance of ApiClient (optional)</param>
        /// <returns></returns>
        public Users_SubscriptionsApi(ApiClient apiClient = null)
        {
        ...
        /// </summary>
        /// <returns></returns>
        public Users_SubscriptionsApi(String basePath)
        {
...
path = path.Replace("{" + "inventory_id" + "}", ApiClient.ParameterToString(inventoryId));
        ...
        /// <param name="status">The new status for the subscription</param> 
        /// <returns></returns>            
        public void SetSubscriptionStatus (int? userId, int? inventoryId, SubscriptionStatusWrapper status)
        {

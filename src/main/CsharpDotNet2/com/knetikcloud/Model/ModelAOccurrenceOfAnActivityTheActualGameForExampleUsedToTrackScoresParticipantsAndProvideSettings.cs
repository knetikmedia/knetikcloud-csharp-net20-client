...
namespace com.knetikcloud.Model {
  ...
  /// </summary>
  [DataContract]
  public class ModelAOccurrenceOfAnActivityTheActualGameForExampleUsedToTrackScoresParticipantsAndProvideSettings {
    /// <summary>
    ...
    public ModelActivityEntitlementResource Entitlement { get; set; }
    ...
    public List<ModelSelectedSettingResource> Settings { get; set; }
    ...
    public List<ModelActivityUserResource> Users { get; set; }
    ...
    public override string ToString()  {
      ...
      sb.Append("class ModelAOccurrenceOfAnActivityTheActualGameForExampleUsedToTrackScoresParticipantsAndProvideSettings {\n");

...
namespace com.knetikcloud.Model {
  ...
  /// </summary>
  [DataContract]
  public class ModelActivityOccurrenceCreationFailure {
    /// <summary>
    ...
    public List<ModelActivityOccurrenceJoinResult> UserResults { get; set; }
    ...
    public override string ToString()  {
      ...
      sb.Append("class ModelActivityOccurrenceCreationFailure {\n");

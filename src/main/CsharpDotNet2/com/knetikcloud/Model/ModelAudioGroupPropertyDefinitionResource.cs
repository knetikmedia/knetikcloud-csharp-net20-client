...
namespace com.knetikcloud.Model {
  ...
  /// </summary>
  [DataContract]
  public class ModelAudioGroupPropertyDefinitionResource : ModelFileGroupPropertyDefinitionResource {
    /// <summary>
    ...
    public ModelPropertyFieldListResource FieldList { get; set; }
    ...
    public override string ToString()  {
      ...
      sb.Append("class ModelAudioGroupPropertyDefinitionResource {\n");

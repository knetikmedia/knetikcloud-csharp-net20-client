...
namespace com.knetikcloud.Model {
  ...
  /// </summary>
  [DataContract]
  public class ModelContributionResource {
    /// <summary>
    ...
    public ModelSimpleReferenceResourcelong Artist { get; set; }
    ...
    public ModelSimpleReferenceResourcelong Media { get; set; }
    ...
    public override string ToString()  {
      ...
      sb.Append("class ModelContributionResource {\n");

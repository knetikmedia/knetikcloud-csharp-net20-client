...
namespace com.knetikcloud.Model {
  ...
  /// </summary>
  [DataContract]
  public class ModelImageGroupPropertyDefinitionResource : ModelFileGroupPropertyDefinitionResource {
    /// <summary>
    ...
    public override string ToString()  {
      ...
      sb.Append("class ModelImageGroupPropertyDefinitionResource {\n");

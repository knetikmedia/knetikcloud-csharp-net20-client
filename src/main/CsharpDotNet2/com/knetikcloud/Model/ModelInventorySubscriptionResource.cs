...
namespace com.knetikcloud.Model {
  ...
  /// </summary>
  [DataContract]
  public class ModelInventorySubscriptionResource {
    /// <summary>
    ...
    public List<ModelSubscriptionCreditResource> CreditLog { get; set; }
    ...
    public ModelPaymentMethodResource PaymentMethod { get; set; }
    ...
    public override string ToString()  {
      ...
      sb.Append("class ModelInventorySubscriptionResource {\n");

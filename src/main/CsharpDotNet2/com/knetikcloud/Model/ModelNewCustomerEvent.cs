...
namespace com.knetikcloud.Model {
  ...
  /// </summary>
  [DataContract]
  public class ModelNewCustomerEvent : ModelBroadcastableEvent {
    /// <summary>
    /// Gets or Sets Client
    /// </summary>
    ...
    /// </summary>
    [DataMember(Name="customer_config", EmitDefaultValue=false)]
    [JsonProperty(PropertyName = "customer_config")]
    public ModelCustomerConfig CustomerConfig { get; set; }
    ...
    public override string ToString()  {
      ...
      sb.Append("class ModelNewCustomerEvent {\n");

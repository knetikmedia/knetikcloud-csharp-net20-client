...
namespace com.knetikcloud.Model {
  ...
  /// </summary>
  [DataContract]
  public class ModelPageResourceAchievementDefinitionResource {
    /// <summary>
    /// Gets or Sets Content
    /// </summary>
    [DataMember(Name="content", EmitDefaultValue=false)]
    [JsonProperty(PropertyName = "content")]
    public List<ModelAchievementDefinitionResource> Content { get; set; }
    ...
    public override string ToString()  {
      ...
      sb.Append("class ModelPageResourceAchievementDefinitionResource {\n");

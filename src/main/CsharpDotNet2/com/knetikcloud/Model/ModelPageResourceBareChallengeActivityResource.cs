...
namespace com.knetikcloud.Model {
  ...
  /// </summary>
  [DataContract]
  public class ModelPageResourceBareChallengeActivityResource {
    /// <summary>
    /// Gets or Sets Content
    /// </summary>
    [DataMember(Name="content", EmitDefaultValue=false)]
    [JsonProperty(PropertyName = "content")]
    public List<ModelBareChallengeActivityResource> Content { get; set; }
    ...
    public override string ToString()  {
      ...
      sb.Append("class ModelPageResourceBareChallengeActivityResource {\n");

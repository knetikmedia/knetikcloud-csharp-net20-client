...
namespace com.knetikcloud.Model {
  ...
  /// </summary>
  [DataContract]
  public class ModelPageResourceCountryTaxResource {
    /// <summary>
    /// Gets or Sets Content
    /// </summary>
    [DataMember(Name="content", EmitDefaultValue=false)]
    [JsonProperty(PropertyName = "content")]
    public List<ModelCountryTaxResource> Content { get; set; }
    ...
    public override string ToString()  {
      ...
      sb.Append("class ModelPageResourceCountryTaxResource {\n");

...
namespace com.knetikcloud.Model {
  ...
  /// </summary>
  [DataContract]
  public class ModelPageResourceFlagReportResource {
    /// <summary>
    /// Gets or Sets Content
    /// </summary>
    [DataMember(Name="content", EmitDefaultValue=false)]
    [JsonProperty(PropertyName = "content")]
    public List<ModelFlagReportResource> Content { get; set; }
    ...
    public override string ToString()  {
      ...
      sb.Append("class ModelPageResourceFlagReportResource {\n");

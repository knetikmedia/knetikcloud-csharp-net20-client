...
namespace com.knetikcloud.Model {
  ...
  /// </summary>
  [DataContract]
  public class ModelPageResourcePermissionResource {
    /// <summary>
    /// Gets or Sets Content
    /// </summary>
    [DataMember(Name="content", EmitDefaultValue=false)]
    [JsonProperty(PropertyName = "content")]
    public List<ModelPermissionResource> Content { get; set; }
    ...
    public override string ToString()  {
      ...
      sb.Append("class ModelPageResourcePermissionResource {\n");

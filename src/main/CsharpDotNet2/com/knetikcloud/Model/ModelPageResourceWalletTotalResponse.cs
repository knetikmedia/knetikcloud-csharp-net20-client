...
namespace com.knetikcloud.Model {
  ...
  /// </summary>
  [DataContract]
  public class ModelPageResourceWalletTotalResponse {
    /// <summary>
    /// Gets or Sets Content
    /// </summary>
    [DataMember(Name="content", EmitDefaultValue=false)]
    [JsonProperty(PropertyName = "content")]
    public List<ModelWalletTotalResponse> Content { get; set; }
    ...
    public override string ToString()  {
      ...
      sb.Append("class ModelPageResourceWalletTotalResponse {\n");

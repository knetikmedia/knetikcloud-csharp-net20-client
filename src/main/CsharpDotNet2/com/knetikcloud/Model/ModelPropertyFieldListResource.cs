...
namespace com.knetikcloud.Model {
  ...
  /// </summary>
  [DataContract]
  public class ModelPropertyFieldListResource {
    /// <summary>
    ...
    public List<ModelPropertyFieldResource> PropertyDefinitionFields { get; set; }
    ...
    public List<ModelPropertyFieldResource> PropertyFields { get; set; }
    ...
    public override string ToString()  {
      ...
      sb.Append("class ModelPropertyFieldListResource {\n");

...
namespace com.knetikcloud.Model {
  ...
  /// </summary>
  [DataContract]
  public class ModelQuestionResource {
    /// <summary>
    ...
    public List<ModelAnswerResource> Answers { get; set; }
    ...
    public ModelNestedCategory Category { get; set; }
    ...
    public ModelProperty Question { get; set; }
    ...
    public override string ToString()  {
      ...
      sb.Append("class ModelQuestionResource {\n");

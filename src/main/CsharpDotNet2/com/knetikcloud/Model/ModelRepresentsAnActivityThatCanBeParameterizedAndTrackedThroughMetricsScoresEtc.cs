...
namespace com.knetikcloud.Model {
  ...
  /// </summary>
  [DataContract]
  public class ModelRepresentsAnActivityThatCanBeParameterizedAndTrackedThroughMetricsScoresEtc {
    /// <summary>
    ...
    public List<ModelActivityEntitlementResource> Entitlements { get; set; }
    ...
    public List<ModelTheDefinitionOfAnActivityParametersExDifficultyLevel> Settings { get; set; }
    ...
    public override string ToString()  {
      ...
      sb.Append("class ModelRepresentsAnActivityThatCanBeParameterizedAndTrackedThroughMetricsScoresEtc {\n");

...
namespace com.knetikcloud.Model {
  ...
  /// </summary>
  [DataContract]
  public class ModelStoreItemTemplateResource {
    /// <summary>
    ...
    public List<ModelItemBehaviorDefinitionResource> Behaviors { get; set; }
    ...
    public ModelTemplateResource SkuTemplate { get; set; }
    ...
    public override string ToString()  {
      ...
      sb.Append("class ModelStoreItemTemplateResource {\n");

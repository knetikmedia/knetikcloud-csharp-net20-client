...
namespace com.knetikcloud.Model {
  ...
  /// </summary>
  [DataContract]
  public class ModelSubscription : ModelStoreItem {
    /// <summary>
    ...
    public List<ModelBehavior> Behaviors { get; set; }
    ...
    public List<ModelSku> Skus { get; set; }
    ...
    public List<ModelSubscriptionPlan> SubscriptionPlans { get; set; }
    ...
    public override string ToString()  {
      ...
      sb.Append("class ModelSubscription {\n");

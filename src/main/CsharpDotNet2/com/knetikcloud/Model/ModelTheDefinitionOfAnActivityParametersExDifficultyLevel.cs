...
namespace com.knetikcloud.Model {
  ...
  /// </summary>
  [DataContract]
  public class ModelTheDefinitionOfAnActivityParametersExDifficultyLevel {
    /// <summary>
    ...
    public List<ModelSettingOption> Options { get; set; }
    ...
    public override string ToString()  {
      ...
      sb.Append("class ModelTheDefinitionOfAnActivityParametersExDifficultyLevel {\n");

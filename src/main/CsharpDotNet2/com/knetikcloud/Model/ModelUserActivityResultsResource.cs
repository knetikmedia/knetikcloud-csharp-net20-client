...
namespace com.knetikcloud.Model {
  ...
  /// </summary>
  [DataContract]
  public class ModelUserActivityResultsResource {
    /// <summary>
    ...
    public List<ModelRewardCurrencyResource> CurrencyRewards { get; set; }
    ...
    public List<ModelRewardItemResource> ItemRewards { get; set; }
    ...
    public override string ToString()  {
      ...
      sb.Append("class ModelUserActivityResultsResource {\n");

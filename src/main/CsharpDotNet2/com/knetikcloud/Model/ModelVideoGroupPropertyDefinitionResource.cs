...
namespace com.knetikcloud.Model {
  ...
  /// </summary>
  [DataContract]
  public class ModelVideoGroupPropertyDefinitionResource : ModelFileGroupPropertyDefinitionResource {
    /// <summary>
    ...
    public override string ToString()  {
      ...
      sb.Append("class ModelVideoGroupPropertyDefinitionResource {\n");

...
namespace com.knetikcloud.Model {
  ...
  /// </summary>
  [DataContract]
  public class ModelVideoResource {
    /// <summary>
    ...
    public ModelSimpleReferenceResourcelong Author { get; set; }
    ...
    public ModelSimpleReferenceResourcestring Category { get; set; }
    ...
    public List<ModelCommentResource> Comments { get; set; }
    ...
    public List<ModelContributionResource> Contributors { get; set; }
    ...
    public ModelSimpleUserResource Uploader { get; set; }
    ...
    public override string ToString()  {
      ...
      sb.Append("class ModelVideoResource {\n");

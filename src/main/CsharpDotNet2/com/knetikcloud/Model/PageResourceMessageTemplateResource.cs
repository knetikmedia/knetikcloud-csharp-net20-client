...
namespace com.knetikcloud.Model {
  ...
  /// </summary>
  [DataContract]
  public class PageResourceMessageTemplateResource {
    /// <summary>
    /// Gets or Sets Content
    /// </summary>
    [DataMember(Name="content", EmitDefaultValue=false)]
    [JsonProperty(PropertyName = "content")]
    public List<MessageTemplateResource> Content { get; set; }
    ...
    public override string ToString()  {
      ...
      sb.Append("class PageResourceMessageTemplateResource {\n");

...
namespace com.knetikcloud.Model {
  ...
  /// </summary>
  [DataContract]
  public class PageResourceNotificationTypeResource {
    /// <summary>
    /// Gets or Sets Content
    /// </summary>
    [DataMember(Name="content", EmitDefaultValue=false)]
    [JsonProperty(PropertyName = "content")]
    public List<NotificationTypeResource> Content { get; set; }
    ...
    public override string ToString()  {
      ...
      sb.Append("class PageResourceNotificationTypeResource {\n");

...
namespace com.knetikcloud.Model {
  ...
  /// </summary>
  [DataContract]
  public class WebsocketUnsubscribeEvent : BroadcastableEvent {
    /// <summary>
    ...
    /// <summary>
    /// Gets or Sets TopicSubscriber
    /// </summary>
    [DataMember(Name="topic_subscriber", EmitDefaultValue=false)]
    [JsonProperty(PropertyName = "topic_subscriber")]
    public TopicSubscriber TopicSubscriber { get; set; }
    ...
    public override string ToString()  {
      ...
      sb.Append("  TopicSubscriber: ").Append(TopicSubscriber).Append("\n");
      sb.Append("}\n");
      return sb.ToString();
    }

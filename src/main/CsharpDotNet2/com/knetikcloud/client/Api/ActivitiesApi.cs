...
namespace com.knetikcloud.client.Api
{
    ...
    public interface IActivitiesApi
    {
        ...
        ActivityOccurrenceResults SetActivityOccurrenceResults (long? activityOccurrenceId, ActivityOccurrenceResults activityOccurrenceResults);
        /// <summary>
        /// Update an activity 
        /// </summary>
        /// <param name="id">The id of the activity</param>
 ...
 if (order != null) queryParams.Add("order", ApiClient.ParameterToString(order)); // query parameter
        ...
        /// <param name="activityOccurrenceResults">The activity occurrence object</param> 
        /// <returns>ActivityOccurrenceResults</returns>            
        public ActivityOccurrenceResults SetActivityOccurrenceResults (long? activityOccurrenceId, ActivityOccurrenceResults activityOccurrenceResults)
        {

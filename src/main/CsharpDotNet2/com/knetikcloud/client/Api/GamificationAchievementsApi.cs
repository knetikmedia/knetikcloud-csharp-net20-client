...
namespace com.knetikcloud.client.Api
{
    ...
    public interface IGamificationAchievementsApi
    {
        ...
        PageResourceAchievementDefinitionResource GetAchievements (string filterTagset, string filterName, bool? filterHidden, bool? filterDerived, int? size, int? page, string order);
        /// <summary>
        ...
        /// <returns>UserAchievementGroupResource</returns>
        UserAchievementGroupResource UpdateAchievementProgress (int? userId, string achievementName, AchievementProgressUpdateRequest request);
        /// <summary>
 ...
 if (order != null) queryParams.Add("order", ApiClient.ParameterToString(order)); // query parameter
        ...
        /// <param name="order">A comma separated list of sorting requirements in priority order, each entry matching PROPERTY_NAME:[ASC|DESC]</param> 
        /// <returns>PageResourceAchievementDefinitionResource</returns>            
        public PageResourceAchievementDefinitionResource GetAchievements (string filterTagset, string filterName, bool? filterHidden, bool? filterDerived, int? size, int? page, string order)
        {
...
path = path.Replace("{" + "achievement_name" + "}", ApiClient.ParameterToString(achievementName));
 ...
 if (page != null) queryParams.Add("page", ApiClient.ParameterToString(page)); // query parameter
        ...
        /// <param name="request">The progress update details</param> 
        /// <returns>UserAchievementGroupResource</returns>            
        public UserAchievementGroupResource UpdateAchievementProgress (int? userId, string achievementName, AchievementProgressUpdateRequest request)
        {
            
            // verify the required parameter 'userId' is set
            if (userId == null) throw new ApiException(400, "Missing required parameter 'userId' when calling UpdateAchievementProgress");
            
            // verify the required parameter 'achievementName' is set
            if (achievementName == null) throw new ApiException(400, "Missing required parameter 'achievementName' when calling UpdateAchievementProgress");
...
path = path.Replace("{" + "achievement_name" + "}", ApiClient.ParameterToString(achievementName));
            ...
            if (((int)response.StatusCode) >= 400)
                throw new ApiException ((int)response.StatusCode, "Error calling UpdateAchievementProgress: " + response.Content, response.Content);
            else if (((int)response.StatusCode) == 0)
                throw new ApiException ((int)response.StatusCode, "Error calling UpdateAchievementProgress: " + response.ErrorMessage, response.ErrorMessage);
